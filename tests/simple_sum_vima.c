...
__v32s main(__v32s argc, char const *argv[]) {
    __v32u *vector_a = (__v32u *) calloc (256, sizeof(__v32u));
    __v32u *vector_b = (__v32u *) calloc (256, sizeof(__v32u));
    __v32u *vector_sum = (__v32u *) calloc (256, sizeof(__v32u));

    _vim64_imovu(10, vector_a);
    _vim64_imovu(5, vector_b);

    __v32u *coeff2 = (__v32u *) calloc (256, sizeof(__v32u));
    __v32u *coeff3 = (__v32u *) calloc (256, sizeof(__v32u));
    __v32u *coeff4 = (__v32u *) calloc (256, sizeof(__v32u));
